...
| :---: | :---: | :--- | :--- | :---: |
| **1** | майстер-клас 1 | **Етап 1 (MIMD):** симуляція ділення нейтронів на CPU (`multiprocessing.Pool`, GIL, 100% CPU benchmark) | Парсинг топології IEEE-118, однопотоковий `run_trial()` | — |
