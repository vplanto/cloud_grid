...
* Для високоінтенсивних чисельних задач (як наші воркери Монте-Карло) стандартного ліміту `cpu.max` у cgroups v2 недостатньо, тому що планувальник ядра Linux CFS може довільно перекидати потоки між сокетами.
