...
> [!IMPORTANT]
> **Методологічний акцент: Топологічний проксі-симулятор vs Промисловий Power Flow (MATPOWER / Закони Кірхгофа)**
> 
> У реальних електричних мережах розподіл струмів підпорядковується **законам Кірхгофа** (KVL / KCL) та закону Ома. Промислові системи (MATPOWER, Cascades, PSS/E) для кожного кроку каскаду розв'язують систему нелінійних рівнянь балансу потужностей (**AC Power Flow**, метод Ньютона-Рафсона) або використовують лінеаризоване матричне наближення (**DC Power Flow** через інверсію матриці вузлових провідностей $\mathbf{B}$ і коефіцієнти розподілу аварійних перетоків **LODF / PTDF**). Через хвильову та контурну природу струму відключення однієї лінії в електродинаміці може спричинити стрибок струму на лінії за 10 вузлів від місця аварії.
> 
> **Чому в курсі використовується топологічна евристика:**
> Мета нашого курсу (122 «Комп'ютерні науки») — не заміна профільного інженерного софту для диспетчерів Укренерго, а **проєктування масштабованих хмарних систем (MIMD, Ray, Docker, Kubernetes, FinOps)** над великими графовими топологіями. Повний розв'язок AC-PF на кожному кроці для $10^6$ траєкторій у Python був би непідйомним за часом і змістив би фокус із системної інженерії на обчислювальну математику.
> 
> Тому в наскрізному проєкті реалізується **топологічний евристичний проксі-симулятор**: локальний перерозподіл потоків між суміжними лініями за їхньою вільною ємністю ($capacity - flow$) виступає ефективною імітацією лавинних каскадних процесів.
...
PowerGraph утворений за допомогою повної моделі **Cascades** (з матричним розрахунком законів Кірхгофа). На нашому курсі реалізується **спрощений топологічний проксі-каскад**:
...
3. **Перерозподіл (евристичний проксі):** потік відключених гілок на активні сусідні (пропорційно вільній ємності $capacity - flow$). Зверніть увагу: це топологічне наближення, яке імітує перевантаження сусідніх ділянок без розв'язання повної системи рівнянь Кірхгофа.
