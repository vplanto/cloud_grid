...
| **DRF** | *Dominant Resource Fairness* | Алгоритм справедливого розподілу ресурсів (CPU/RAM/GPU) між великими batch-задачами |
| **Bin-packing** | упаковка | Щільне розміщення багатьох Pod'ів на вузлах K8s |
| **K8s** | *K-ubernete-s* (нумеронім: K + 8 літер + s) | Загальноприйняте скорочення для Kubernetes — оркестратора контейнерів у хмарі |
