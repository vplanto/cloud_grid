...
> 1. **Закони фізики та виміри простору-часу:** швидкість світла $c \approx 300\,000$ км/с (сигнал проходить ~30 см за 1 нс — непорушна фізична межа затримок шин і оптики), закони термодинаміки (розсіювання тепла процесорами, TDP серверів).
